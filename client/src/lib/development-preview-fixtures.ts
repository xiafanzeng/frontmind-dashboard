    ...
    events: [
      {
        ...
        actorLabel: "验收企业 A",
        message: "已补充案例背景，客户名称暂不公开，可使用行业与应用场景描述。",
        createdAt: "2026-07-26T10:15:00+08:00",
      },
      {
        id: "event-2",
        visibility: "internal",
        eventType: "internal_note",
        actorLabel: "FrontMind Admin",
        message: "需在受理前再次核验产品参数与图片授权范围。",
        createdAt: "2026-07-26T11:20:00+08:00",
      },
    ],
